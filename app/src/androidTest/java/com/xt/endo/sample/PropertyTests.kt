...
class PropertyTests {
    ...
    fun testProperties() {
        ...
        context.executeScript("obj.arrayValue = [1, 2, 3, 4]")
        ...
        context.executeScript("obj.dictValue = {aKey: 'aValue'}")
        assertEquals(obj.dictValue["aKey"], "aValue")
        context.executeScript("obj.nilValue = undefined")
        assertEquals(obj.nilValue, null)
        context.executeScript("obj.objectValue = new FooObject")
        assertTrue(obj.objectValue is FooObject)
        context.executeScript("obj.readonlyIntValue = 2")
