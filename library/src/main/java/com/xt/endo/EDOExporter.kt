...
class EDOExporter {
    ...
    fun exportWithContext(context: V8) {
        ...
        while (exportables.count() > 0) {
            ...
            exportables.toMap().forEach {
                ...
                val clazzScript = ";var ${it.key} = /** @class */ (function (_super) {;__extends(Initializer, _super) ;$constructorScript; $propsScript ; $methodScript;return Initializer; }(${it.value.superName}));"
                script += clazzScript
    ...
    fun createInstance(name: String, arguments: V8Array, owner: V8Object): V8Value {
        val sss = EDOObjectTransfer.convertToNSArgumentsWithJSArguments(arguments, owner)
